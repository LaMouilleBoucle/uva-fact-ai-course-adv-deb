...
def test(dataloader_test, predictor, optimizer_P, criterion, metric, adversary, optimizer_A, scheduler, device):
    ...
    if args.dataset == 'adult':
        ...
        logger.info(f'For men: precision {neg_prec}, recall {neg_recall}, F1 {neg_fscore}, support {neg_support}, AUC {neg_auc}.')
        logger.info(f'For women: precision {pos_prec}, recall {pos_recall}, F1 {pos_fscore}, support {pos_support}, AUC {pos_auc}.')
