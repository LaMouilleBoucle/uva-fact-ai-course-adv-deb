...
def calculate_metrics(true_labels, predictions, true_protected, dataset, pred_probs=None):
    ...
    if dataset == 'adult':
        ...
        neg_prec, neg_recall, neg_fscore, neg_support = precision_recall_fscore_support(true_labels[negative_indices], predictions[negative_indices])
        pos_prec, pos_recall, pos_fscore, pos_support = precision_recall_fscore_support(true_labels[positive_indices], predictions[positive_indices])
